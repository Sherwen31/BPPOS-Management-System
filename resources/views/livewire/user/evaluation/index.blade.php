    ...
    <div class="containerMod">
        ...
        <div class="mainMod" style="padding: 0;">
            <div class="sec">
                ...
                <div class="container">
                    <div class="greeting">
                        <h1>Good day <strong>{{ auth()->user()->first_name }} {{ auth()->user()->last_name }} </strong>!
                    ...
                    <div class="form-group">
                        ...
                        @endphp
                        @if($canEvaluate)
                        <a wire:navigate href="/users/evaluation/send-attachment/{{ auth()->user()->id }}/{{ auth()->user()->police_id }}"
                            class="send-button">
