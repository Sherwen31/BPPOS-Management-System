        ...
        <section class="mainMod">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex gap-3">
                    <input type="search" wire:model.live.debounce.200ms="search" class="form-control w-50" placeholder="Search...">
                    <div class="d-flex align-items-center gap-1"><label for="show" class="fw-bold">Show</label>
                        <select wire:model.live.debounce.300ms='show' id="" class="form-select">
                            <option selected hidden>{{ $show }}</option>
                            <option disabled>Show filter</option>
