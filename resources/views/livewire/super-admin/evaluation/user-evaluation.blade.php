<div>
    <div class="container mt-5">
        ...
        <!-- Progress Indicator -->
        <livewire:super-admin.evaluation.rating-indicator>
            <h3 class="text-center"><strong>Police Name:</strong> <u>{{ $last_name }}{{ $last_name ? ',' : '' }} {{
                    $first_name }}</u></h3>
            <div class="progress-container mb-4">
                <span
                    class="step-indicator {{ $activeTab === 1 || $activeTab === 2 || $activeTab === 3 ? 'active' : '' }}"
                ...
                <span class="step-indicator {{ $activeTab === 2 || $activeTab === 3 ? 'active' : '' }}"
                    id="step2-indicator" wire:click="setActiveTab(2)" style="cursor: pointer;">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="form-group col-4">
                                ...
                                <select wire:model='user_reviewer_id' id="" class="form-select">
                                    ...
                                    <option value="{{ $reviewer->id }}">{{ $reviewer->first_name }} {{
                                        $reviewer->last_name
                                        }}
                                    </option>
                                    @empty
                                ...
                                <div class="mb-3">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="table-dark">
                                            ...
                                            <td>Uploaded Attachment for Evidence</td>
                                            ...
                                            <tr wire:key='{{ $item->id }}'>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary btn-sm"
                                                        href="{{ Storage::url($attachment->attachment) }}" taget="_blank">
                                                ...
                                                <td>
                                                    <input type="number"
                                                        ...
                                                        class="form-control number-input multiplier-input" min="1"
                                                        max="5" step="1">
                                                ...
                                                <td class="result">
                                                    <span wire:loading.remove
                                                        ...
                                                        (int)$numerical_rating[$item->id] * (int)$item->point_allocation
                                                        : 0
                                                        }}
                                                    </span>
