...
<head>
    ...
    <meta name="title" content="{{ $title ?? 'BPPOS Management System' }}">
    <meta name="description" content="{{ $title ?? 'BPPOS Management System' }}">
    <meta name="author" content="Anonymous Secret">
